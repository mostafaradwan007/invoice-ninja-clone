  ...
  <div class="main-content">
    ...
    <div class="page-controls">
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./transaction-import.php'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Product Button -->
        <button class="new-product-btn" type="button" onclick="window.location.href='./transactions-create.php'">
          New Transaction
        </button>
      </div>
    </div>
