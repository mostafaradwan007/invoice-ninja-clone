        ...
        <div class="breadcrumb-container">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                        <a href="./recurring-expenses.php">Recurring Expenses</a>
                    </li>
                    ...
                    <div class="modal hidden" id="vendorModal">
                        <div class="modal-content">
                            ...
                            <div class="button-row">
                                <button type="button" onclick="openMoreFields(this)" data-url="#">More Info</button> <!--for vendor page-->
                    ...
                    <div class="modal hidden" id="projectModal" >
                        ...
                        <div class="modal-content">
                            ...
                            <div class="button-row">
                                ...
                                <button type="button" id="save" onclick="saveprojectclient()">Save</button>
                            </div>
                        </div>
                    </div>
                    <!--More info -->
    ...
    <option value="new">-- New User --</option>
                    ...
                    <div class="modal hidden" id="categoryModal">
                        <div class="modal-content">
                            ...
                            <input type="color" id="categorycolor" name="categorycolor" value="#ff0000" style="width: 50px; height: 30px; border: none; padding: 0;">
            ...
            <div class="right-column">
                <div class="panel">
                    ...
                    <hr style="color:lightgray;">
                    <div class="form-row">
                        <label><b>Should Be Invoiced</b> <br><span style="color:grey;">Enable the expense to be invoiced</span></label>
                    ...
                    <div class="form-row">
                        <label><b>Convert currency
                            </b> <br><span style="color:grey;">Set an exchange rate when creating an expense</span></label>
            ...
            <a href="./recurring-expenses.php" class="btn-cancel">Cancel</a>
