...
<head>
  ...
  <title>Import Purchase Orders - Bee Company</title>
  ...
  <div class="main-content">
    ...
    <div class="import-content">
      <div class="import-section">
        <h1 class="section-title">Import Purchase Orders</h1>
        ...
        <form id="importForm" action="#" method="POST" enctype="multipart/form-data">
          ...
          <div class="help-text">
            ...
            <div class="help-content">
              ...
              <ul>
                <li>PO Number (required)</li>
                <li>Vendor Name (required, must match an existing vendor)</li>
                <li>PO Date (required, format YYYY-MM-DD)</li>
                <li>Due Date (optional, format YYYY-MM-DD)</li>
                <li>Amount (required)</li>
                <li>Status (optional: Draft, Sent, Approved, etc.)</li>
              </ul>
          ...
          <div class="import-actions">
            <a href="purchase-orders.php" class="cancel-btn">Cancel</a>
            <button type="submit" class="import-btn" id="importBtn">Import Purchase Orders</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.getElementById('downloadTemplate').addEventListener('click', function(e) {
        e.preventDefault();
        const csvContent = 'PO Number,Vendor Name,PO Date,Due Date,Amount,Status\n' +
                         'PO-2025-001,Office Supplies Inc.,2025-08-01,2025-08-31,450.00,Sent\n' +
                         'PO-2025-002,Marketing Solutions,2025-08-05,2025-09-05,1200.50,Draft';
