...
<head>
  ...
  <title>Import Tasks - Bee Company</title>
  ...
  <div class="main-content">
    ...
    <div class="import-content">
      <div class="import-section">
        <h1 class="section-title">Import Tasks</h1>
        ...
        <form id="importForm" action="#" method="POST" enctype="multipart/form-data">
          ...
          <div class="help-text">
            ...
            <div class="help-content">
              ...
              <ul>
                ...
                <li>Duration (optional, format H:MM e.g., 1:30)</li>
                <li>Client Name (optional, must match an existing client)</li>
                <li>Project Name (optional, must match an existing project)</li>
              </ul>
          ...
          <div class="import-actions">
            ...
            <button type="submit" class="import-btn" id="importBtn">Import Tasks</button>
          </div>
        </form>
      </div>
    </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.getElementById('downloadTemplate').addEventListener('click', function(e) {
        e.preventDefault();
        const csvContent = 'Description,Task Date,Duration,Client Name,Project Name\n' +
                         '"Design mockups for new website",2025-08-01,2:45,Client A,Website Redesign\n' +
                         '"Develop backend API for auth",2025-08-02,15:30,Client B,Mobile App API';
