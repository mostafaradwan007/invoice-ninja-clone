...
<head>
  ...
  <title>Quotes - Bee Company</title>
    ...
    <div class="page-controls">
      <div class="left-controls">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#">Archined</a></li>
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./quote-import.php'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Quote Button -->
        <button class="new-Quote-btn" type="button" onclick="window.location.href='./quote-create.php'">
          Add Quote
        </button>
      </div>
    </div>
