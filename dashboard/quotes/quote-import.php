...
<head>
  ...
  <title>Import Quote - Bee Company</title>
    ...
    <div class="breadcrumb-container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="./Quote.php">Quote</a></li>
      ...
      <div class="import-section">
        ...
        <form id="importForm" enctype="multipart/form-data">
          ...
          <div class="import-actions">
            <button type="button" class="cancel-btn" onclick="window.location.href='./Quote.php'">
              Cancel
            </button>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      importForm.addEventListener('submit', function(e) {
        ...
        setTimeout(function() {
          ...
          /*
          fetch('process-Quote-import.php', {
            method: 'POST',
            body: formData
          })
      ...
      document.getElementById('downloadTemplate').addEventListener('click', function(e) {
        ...
        // Create sample CSV content for Quote
        const csvContent = 'Quote Name,Description,Price,Default Quantity,SKU,Category\n' +
        ...
        a.href = url;
        a.download = 'Quote-import-template.csv';
