...
<head>
  ...
  <title>New Quote - Bee Company</title>
...
<body>
              ...
              <div class="Quote-details-left">
                <div class="form-group">
                  ...
                  <div class="date-input-group">
                    <input type="date" class="form-control" id="Quote_date" name="Quote_date" value="2025-08-01">
  ...
  <script>
    ...
    // Form submission
    document.getElementById('newQuoteForm').addEventListener('submit', function(event) {
