 <style>
     ...
     .group-table thead th.sortable {
         cursor: pointer;
         user-select: none;
     }

     .group-table thead th.sortable:hover {
         background-color: #2563eb;
     }

     .group-table thead th.sortable::after {
         content: "↕";
         position: absolute;
         right: 8px;
         top: 50%;
 ...
 <div class="main-content tab-content active" id="user-table-tab">
     ...
     <div class="right-actions">
         ...
         <button class="new-group-btn tab" onclick="showuserTab('group')" type="button">
             Add Group 
         </button>
 ...
 <!-- group Table -->
 <div class="group-table-container tab-content active" id="group-table-tab">
 ...
 <div id="user-group-tab" class="tab-content">
     ...
     <script>
         function showuserTab(tabName) {
             ...
             const groupTab = 'group-table-tab';
             if (targetTab) {
