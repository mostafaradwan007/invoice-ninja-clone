...
<head>
  ...
  <title>Recurring Invoices - Bee Company</title>
  ...
  <style>
    ...
    .new-recurring-invoice-btn:hover {
  ...
  <div class="main-content">
    ...
    <div class="breadcrumb-container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page">Recurring Invoices</li>
        </ol>
      </nav>
    </div>
    ...
    <div class="page-controls">
      <div class="left-controls">
        ...
        <div class="actions-dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#"><i class="bi bi-play me-2"></i>Start Selected</a></li>
            <li><a class="dropdown-item" href="#"><i class="bi bi-pause me-2"></i>Pause Selected</a></li>
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./recurring-invoice-import.php'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Recurring Invoice Button -->
        <button class="new-recurring-invoice-btn" type="button" onclick="window.location.href='./recurring-invoice-create.php'">
          ...
          <tr>
            <td colspan="10">
              <div class="empty-state">
                ...
                <div class="empty-state-subtext">Start by creating your first recurring invoice</div>
              </div>
            </td>
          </tr>
        </tbody>
