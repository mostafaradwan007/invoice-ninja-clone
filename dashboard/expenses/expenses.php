...
<head>
  ...
  <title>Expenses - Bee Company</title>
  ...
  <style>
    ...
    .new-expense-btn { background-color: var(--primary-blue); }
  ...
  <div class="main-content">
    ...
    <div class="page-controls">
      ...
      <div class="right-controls">
        ...
        <a href="expense-import.php" class="import-btn">
          <i class="bi bi-download"></i> Import
        </a>
        <a href="expense-create.php" class="new-expense-btn">
          New Expense
        </a>
      </div>
    </div>
