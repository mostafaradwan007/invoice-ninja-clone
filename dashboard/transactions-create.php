                ...
                <div class="tab-pane fade show active" id="create" role="tabpanel">
                    <form id="newtransactionsForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <label class="form-label" for="description">Date</label>
                            ...
                            <div class="form-row">
                                ...
                                <select id="bankSelect" class="form-control">
                                    ...
                                    <option value="new">+ Add Bank Account</option>
                                </select>
                            </div>
                            <div class="modal hidden" id="bankModal">
                                <div class="modal-content">
                                    <span class="close" onclick="closebankModal()">×</span>
                                    <h3>Add Bank Account</h3>
                                    <label>Name</label>
                                    <input type="text" id="bankName">

                                    <div class="button-row">
                                        <button type="button" id="save" onclick="savebank()">Save</button>
                                    </div>
                                </div>
                            </div>
                            <!--More info -->
