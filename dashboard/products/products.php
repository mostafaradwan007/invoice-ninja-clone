  ...
  <div class="main-content">
    ...
    <div class="page-controls">
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./products-import.php'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Product Button -->
        <button class="new-product-btn" type="button" onclick="window.location.href='./product-create.php'">
          New Product
        </button>
      </div>
    </div>
