...
<head>
  ...
  <!-- =================================================================== -->
  <!-- This is the exact same CSS from your products-create.php file       -->
  <!-- =================================================================== -->
  <style>
    :root {
      --bee-yellow: #ffcc00;
  ...
  <div class="main-content">
    ...
    <div class="form-container">
      <div class="form-card">
        ...
        <form id="newVendorForm" action="#" method="POST">
          <!-- Vendor Name (Required) -->
          <div class="form-group">
            <label class="form-label required" for="vendor_name">Vendor Name</label>
          ...
          <div class="form-actions">
            <a href="vendors.php" class="btn-cancel">Cancel</a>
