...
<head>
  ...
  <title>New Credit - Bee Company</title>
...
<body>
              ...
              <div class="Credit-details-left">
                <div class="form-group">
                  ...
                  <div class="date-input-group">
                    <input type="date" class="form-control" id="Credit_date" name="Credit_date" value="2025-08-01">
              ...
              <div class="notes-section">
                ...
                <div class="tab-content" id="notesTabsContent">
                  <div class="tab-pane fade show active" id="public-notes" role="tabpanel">
                    <textarea class="form-control" rows="4" placeholder="Add public notes..."></textarea>
                  </div>
  ...
  <script>
    ...
    // Form submission
    document.getElementById('newCreditForm').addEventListener('submit', function(event) {
      event.preventDefault();
      console.log('Credit form submitted');
