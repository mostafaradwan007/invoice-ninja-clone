  ...
  <div class="main-content">
    ...
    <div class="page-controls">
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./invoice-import.php'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Invoice Button -->
        <button class="new-invoice-btn" type="button" onclick="window.location.href='./invoice-create.php'">
          New Invoice
        </button>
      </div>
    </div>
