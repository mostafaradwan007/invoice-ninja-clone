  ...
  <div class="main-content">
    ...
    <div class="page-controls">
      ...
      <div class="right-controls">
        ...
        <!-- Import Button -->
        <button class="import-btn" type="button" onclick="window.location.href='./payment-import.php'">
          <i class="bi bi-download"></i>
          Import
        </button>

        <!-- New Payment Button -->
        <button class="new-Payment-btn" type="button" onclick="window.location.href='./payment-create.php'">
          Add Payment
        </button>
      </div>
    </div>
